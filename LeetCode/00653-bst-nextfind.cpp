...
public:
    ...
    bool findTarget(TreeNode* root, int k) {
        ...
        // If the top element of the stack doesn't have the left child, stop there, pop the element, and insert the right child node if exists.
        // At the next step, iterate that.
        ...
        if (smallest_elmt != biggest_elmt && smallest_elmt->val + biggest_elmt->val == k) {
            return true;
        }
        return false;
    }
