...
public:
    ...
    void reverseRightBoundaryOfBinaryTree(TreeNode* root, vector<int> &right, int height) {
    ...
    vector<int> boundaryOfBinaryTree(TreeNode* root) {
        ...
        for(int l: left) boundary.push_back(l);
        for(int lf: leaves) boundary.push_back(lf);
        for(int r: right) boundary.push_back(r);
        return boundary;
    }
};
