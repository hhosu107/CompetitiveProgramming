...
// for each call, maxim contains absolute maximum difference from any ancestor to any childs,
// while mx and mi only contains the path maximum and path minimum by this construction.
/*
 * An insight is that:
